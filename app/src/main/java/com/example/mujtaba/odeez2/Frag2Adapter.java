 ...
 */
public class Frag2Adapter extends RecyclerView.Adapter<Frag2Adapter.CartViewHolder> {
    private List<testitems> listdata ;
    private Context context;

    public Frag2Adapter(List<testitems> listdata, Context context) {
        this.listdata = listdata;
        this.context = context;
    }

    @Override
    public Frag2Adapter.CartViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_cartnew, parent, false);
        return new Frag2Adapter.CartViewHolder(v);
    }

    @Override
    public void onBindViewHolder(Frag2Adapter.CartViewHolder holder, int position) {
    ...
    public static class CartViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public CartViewHolder(View itemView) {
            super(itemView);
            txt_cart_name = (TextView) itemView.findViewById(R.id.cart_item_namen);
            txt_price = (TextView) itemView.findViewById(R.id.cart_pricen);
            txt_quantity = (TextView) itemView.findViewById(R.id.quantityn);
            img_cart = (ImageView)itemView.findViewById(R.id.mmmn);
