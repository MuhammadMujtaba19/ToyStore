...
public class MyFirebaseInstanceService extends FirebaseMessagingService {
    ...
    private void showNotification(Map<String, String> data) {
        ...
        String NOTIFICATION_ID = "com.example.mujtaba.odeez2";
...
//
        ...
        notificationBuilder.setAutoCancel(true).setDefaults(Notification.DEFAULT_ALL).setWhen(System.currentTimeMillis()).setSmallIcon(R.drawable.abc_icon)
